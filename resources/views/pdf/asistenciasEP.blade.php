...
<div class="container-fluid" style="margin-top:   50px;
    ...
    <h4 style="text-align: right;">
        <div style="text-align: left;">
            ...
            <form action="{{ asset('/AsistenciasEP/Exportar')}}" method="get">
                <input type="hidden" name="nombre" value={{$nombre}}></input>
                <input type="hidden" name="ap_paterno" value={{$ap_paterno}}></input>
                <input type="hidden" name="ap_materno" value={{$ap_materno}}></input>
    ...
    <h4>
        Periodo:<br>
        {{Date::parse($inicio)->format('j \d\e F \d\e Y')}} al {{Date::parse($fin)->format('j \d\e F \d\e Y')}}<br>
    </h4>    
